...
theme(panel.background = element_blank()) + 
  ...
  guides(fill = guide_legend(override.aes = list(pch=21, size = 4, colour="black")),
         shape = guide_legend(override.aes = list(size = 4, fill="black"))) + 
         annotate("text", x = -0.16, y = 0.15, label = "bacteria-2011")
...
theme(panel.background = element_blank()) + 
  ...
  guides(fill = guide_legend(override.aes = list(pch=21, size = 4, colour="black")),
         shape = guide_legend(override.aes = list(size = 4, fill="black"))) + 
         annotate("text", x = -0.16, y = 0.15, label = "bacteria-2012")
bact.2012
...
theme(panel.background = element_blank()) + 
  ...
  guides(fill = guide_legend(override.aes = list(pch=21, size = 4, colour="black")),
         shape = guide_legend(override.aes = list(size = 4, fill="black"))) + 
         annotate("text", x = -0.16, y = 0.15, label = "bacteria-2013")
...
theme(panel.background = element_blank()) + 
  ...
  guides(fill = guide_legend(override.aes = list(pch=21, size = 4, colour="black")),
         shape = guide_legend(override.aes = list(size = 4, fill="black"))) + 
         annotate("text", x = -0.15, y = 0.27, label = "nematodes-2011")
nema.2011
