...
#bac.ind for mgmt
library("labdsv")
# analysis for df = new.data.2013

trt.mgmt <- new.data.2013$Management
bact.2013.dataREL <- new.data.2013[,-c(1:9)]
bact.2013.dataREL <- bact.2013.dataREL[, colSums(bact.2013.dataREL) > 0.05]
bac.ind <- indval(bact.2013.dataREL, trt.mgmt)
levels(trt.mgmt)
summary(bac.ind)
...
write.table(indicator.bac, "../data/BacterialIndicators_Management.txt",
...
trt.plant <- new.data.2013$Plant
bact.2013.dataREL <- new.data.2013[,-c(1:9)]
bact.2013.dataREL <- bact.2013.dataREL[, colSums(bact.2013.dataREL) > 0.05]
bac.ind <- indval(bact.2013.dataREL, trt.plant)
levels(trt.plant)
summary(bac.ind)
