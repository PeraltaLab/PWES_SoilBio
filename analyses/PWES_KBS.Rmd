...
# fit <- envfit(pcoa, soil.2011.df)
#playing around with vector overlay


# Added by Mario ######
soil2 <- soil[soil$Year == 2011, 17:22]
fit <- envfit(pcoa,soil2,perm=1000)
fit.coords <- as.data.frame(fit$vectors$arrows) * 0.1
############

###need to add arrows on PCoA - not done yet
